...
run-hendler-screen:
	screen -dmS hendler bash -c "pipenv run python ./hendler/hendler.py config.ini"

run-monitor:
	pipenv run ./hendler/hendler.py config.ini


run-monitor-screen:
	screen -dmS analyser bash -c "pipenv run python ./analyser/analyser.py config.ini"

run-monitor:
	pipenv run ./analyser/analyser.py config.ini
